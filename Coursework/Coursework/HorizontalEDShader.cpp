// Horizontal edge detection shader
#include "HorizontalEDShader.h"



HorizontalEDShader::HorizontalEDShader(ID3D11Device* device, HWND hwnd) : BaseShader(device, hwnd)
{
	initShader(L"horizontalED_vs.cso", L"horizontalED_ps.cso");
}
...
void HorizontalEDShader::initShader(const wchar_t* vsFilename, const wchar_t* psFilename)
{
...
void HorizontalEDShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, ID3D11ShaderResourceView* texture, float width)
{
