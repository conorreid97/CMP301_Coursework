// Vertical edge detection shader
#include "VerticalEDShader.h"



VerticalEDShader::VerticalEDShader(ID3D11Device* device, HWND hwnd) : BaseShader(device, hwnd)
{
	initShader(L"verticalED_vs.cso", L"verticalED_ps.cso");
}
...
void VerticalEDShader::initShader(const wchar_t* vsFilename, const wchar_t* psFilename)
{
...
void VerticalEDShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, ID3D11ShaderResourceView* texture, float height)
{
